...
OWNERSHIP_MAP = {
    ...
    "capt:flask":        ["web/app.py", "cage-web/src/main.rs", "cage-web/src/routes/pages.rs"],
    ...
    "capt:sessions":     ["cage-web/src/routes/sessions.rs"],
    "dept:orchestration": ["cage-web/src/routes/gentlyos.rs"],
    "dept:runtime":      ["cage-web/src/subprocess.rs"],
